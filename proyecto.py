...
for node in xml.xpath('/ItemSearchResponse/Items/Item/ItemAttributes/Title/text()', namespaces=ns):
#for node in xml.xpath('/ns:ItemSearchResponse/Items/Item/ItemAttributes/Title/text()', namespaces=ns):
print node
